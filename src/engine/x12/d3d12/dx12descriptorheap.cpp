	...
	, parent(parent_)
{
	...
	d3d12DescriptorHeap = d3d12::CreateDescriptorHeap(d3d12::CR_GetD3DDevice(), numDescriptorsInPage, heapType);

	d3d12::set_name(d3d12DescriptorHeap.Get(), L"Descriptor heap page for static resources %u descriptors", numDescriptorsInPage);
